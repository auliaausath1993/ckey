...
.controller('konfirmasipembayaranController', function($ionicPlatform, $scope, $state, $http, $ionicLoading, $ionicPopup, $ionicHistory, $window, dataMessageService, dataPesananService, $ionicPopover, $ionicActionSheet, $cordovaCamera, $cordovaFile, $cordovaFileTransfer, $cordovaDevice) {
	$scope.postData = {};
	...
	$scope.selectPicture = function(sourceType) {
		var options = {
			quality: 30,
			destinationType: 1,
			//coba langsung pakai kode FILE_URI 1, DATA_URL 0
		...
		$ionicPlatform.ready(function() {
			...
			$cordovaCamera.getPicture(options).then(function(imagePath) {
				...
				if ($cordovaDevice.platform == 'Android' && sourceType === 0) {
